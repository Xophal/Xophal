...
export default async function DashboardPage() {
  ...
  const quickLinks = [
    ...
    { href: ROUTES.tests, icon: "Target", label: "Mock Tests", desc: "Practice with timed tests" },
          ...
          <div className="max-w-2xl">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Button asChild className="dashboard-primary-action rounded-full px-5">
                <Link href={ROUTES.tests}><Play className="mr-2 h-4 w-4 fill-current" /> Start a mock test</Link>
              </Button>
